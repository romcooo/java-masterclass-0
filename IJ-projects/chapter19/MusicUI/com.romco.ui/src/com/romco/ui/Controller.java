package com.romco.ui;

import com.romco.common.Album;
import com.romco.common.Artist;
import com.romco.db.Datasource;
        ...
        Task<Boolean> task = new Task<Boolean>() {
            ...
            protected Boolean call() throws Exception {
                return Datasource.getInstance()
                        .updateArtistByArtistId(artist.getName()+"_UPDATED", artist.getId());
            }
        };
        
        task.setOnSucceeded(e -> {
            if (task.valueProperty().get()) {
                artist.setName(artist.getName() + "_UPDATED");
                artistTable.refresh();
            }
        });
